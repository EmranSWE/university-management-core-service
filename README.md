...
```bash
[git clone https://github.com/Programming-Hero-Next-Level-Development/university-management-core-service-starter.git university-management-core-service](https://github.com/EmranSWE/university-management-core-service.git)
```
